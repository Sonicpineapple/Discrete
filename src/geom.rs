...
pub(crate) fn rank_3_mirrors(a: usize, b: usize) -> Option<[Blade3; 3]> {
...
fn rank_3_mirrors_internal(a1: f64, a2: f64) -> Option<[Blade3; 3]> {
    ...
    let vertex_2_3 = (u & mirror2).unpack_point_pair()?[0];
